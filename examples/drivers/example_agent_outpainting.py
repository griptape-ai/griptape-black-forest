...
agent.run(
    "Replace the environment in assets/dog_skateboard_watercolor.jpeg, with boat at sea, using the assets/dog_skateboard_env_mask.jpeg. Save it as dog_skateboard_at_sea.jpeg."
)
